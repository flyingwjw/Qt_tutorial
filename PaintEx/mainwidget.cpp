    ...
    : QWidget(parent)
{
    ...
    shapeComboBox->addItem(tr("Rectangel"), PaintArea::Rectangel);
    ...
    penCapLabel = new QLabel(tr("PenCap: "));
    ...
    penJoinComboBox->addItem(tr("SvgMiterJoin"), Qt::SvgMiterJoin);
    connect(penJoinComboBox, SIGNAL(activated(int)), this, SLOT(ShowPenJoin(int)));

    fillRuleLabel = new QLabel(tr("FillRule: "));
    fillRuleCombbBox = new QComboBox;
    fillRuleCombbBox->addItem(tr("OddEvenFill"), Qt::OddEvenFill);
    fillRuleCombbBox->addItem(tr("WindingFill"), Qt::WindingFill);
    connect(fillRuleCombbBox, SIGNAL(activated(int)), this, SLOT(ShowFillRule()));

    spreadLabel = new QLabel(tr("Spread: "));
    ...
    brushColorLabel = new QLabel(tr("BrushColor: "));
    ...
    rightLayout->addWidget(fillRuleCombbBox, 6, 1);
...
{
    Qt::FillRule rule = Qt::FillRule(fillRuleCombbBox->itemData(fillRuleCombbBox->currentIndex(), Qt::UserRole).toInt());
